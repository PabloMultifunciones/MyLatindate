    ...
    this.refresh = function($icons){
        ...
        for(var i = 0; i < $icons.length; i++){
            ...
            $icons[i].element.onclick = function(){
                ...
                Cookies.set('lang',this.childNodes[0].getAttribute('icon-index'));
                window.location.href="home/set_site_languaje/"+this.childNodes[0].getAttribute('icon-value');
